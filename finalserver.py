...
# STORES USERS
listOfUsers = []
# STORES DICTIONARY OF USERS FOR GAME REQUESTS
userDictionary = {}

# STORES ALL CLIENTS. ALLOWS FOR MULTIPLE CONNECTIONS
allConnections = set()

# HANDLES NEW CONNECTIONS AND REMOVES CONNECTIONS
...
# HANDLES THE MSGS RECEIVED FROM CLIENT
# AND REDIRECTS THEM
...
# GAME REQUEST:
#   GET THE ID AND SEND A GAME REQUEST TO THAT PLAYER
...
# GAME ACCEPT:
#   GET THE ID AND ACCEPT THE MATCH
#   CONTACT THE CLIENT
...
# ADD USER:
#   CHECKS IF THAT ID DOES NOT EXIST.
#       IF IT DOESNT, ADD TO THE LIST.
#       SEND ID TO CLIENTS FOR DISPLAY REASONS
...
# BROADCASTS TO EVERYONE WHICH PLAYER HAS JOINED
